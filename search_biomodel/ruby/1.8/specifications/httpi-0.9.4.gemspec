...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pyu-ntlm-http>, [">= 0.1.3.1"])
      ...
      s.add_development_dependency(%q<mock-server>, ["~> 0.1.1"])
    else
      s.add_dependency(%q<rack>, [">= 0"])
      s.add_dependency(%q<pyu-ntlm-http>, [">= 0.1.3.1"])
      s.add_dependency(%q<rspec>, ["~> 2.2"])
      s.add_dependency(%q<autotest>, [">= 0"])
      s.add_dependency(%q<mocha>, ["~> 0.9.9"])
      s.add_dependency(%q<webmock>, ["~> 1.4.0"])
      s.add_dependency(%q<mock-server>, ["~> 0.1.1"])
    end
  else
    s.add_dependency(%q<rack>, [">= 0"])
    s.add_dependency(%q<pyu-ntlm-http>, [">= 0.1.3.1"])
